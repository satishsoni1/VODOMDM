...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Onboard New Client</li>
@endsection
...
<div class="card">
    <div class="card-header"><strong><i class="bi bi-briefcase me-2"></i>Step 1 — Client Details</strong></div>
    <div class="card-body">
        <form method="POST" action="{{ route('onboarding.store') }}">
            ...
            <div class="d-flex gap-2 mt-4">
                <button type="submit" class="btn btn-primary"><i class="bi bi-arrow-right"></i> Create Client & Continue</button>
